...
#
# Last updated for STOPGAP 0.7.3
# WW 12-2023
...
# Directory options
rootdir='rootdir'  # Root subtomogram averaging directory
...
# Job parameters
subtomo_mode='ali_singleref'                    # Subtomogram averaging mode (see above)
startidx=1                                      # Starting index (i.e. motivelist to be read)
iterations=1                                    # Number of iterations with current parameters
binning=1                                       # Binning factor of subtomograms

# Main file options
motl_name='motl_name'                           # Rootname of motivelist. Filenames will be [motlname]_[iteration].star.
ref_name='ref_name'                             # Rootname of reference. Output names will be [reffilename]_[iteration].em or [reffilename]_[class]_[iteration].em.
mask_name='mask_name.mrc'                       # Filename of alignment mask. Required for both averaging and alignment.
ccmask_name='ccmask_name.mrc'                   # Filename of cross-correlation mask. Required for FLCF-based scoring. Set to 'none' for no ccmask.
wedgelist_name='wedgelist.star'                 # Filename of wedgelist.
subtomo_name='subtomo'                          # Rootname of subtomograms. By default, filenames are [subtomoname]_[subtomo_num].mrc
...
# Search mode
search_mode='hc'                                # 'hc' is a normal greedy search. 'shc' for stochastic hill climbing approach.
...
ignore_halfsets=0                               # Ignore halfsets during alignment.
temperature=0                                   # Temperature factor for simulated annealing. To disable, set to 0.
